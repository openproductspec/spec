...
[ProductSpec](https://github.com/gokulrajaram/ProductSpec) — the Markdown format
for recording product intent before implementation.
...
See the [ProductSpec repository](https://github.com/gokulrajaram/ProductSpec) for
the specification, schemas, examples, and documentation.
